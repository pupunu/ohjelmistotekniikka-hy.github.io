...
- GitHub liittää automaattisesti projektin lähdekoodin zip-pakattuna releaseen. **HUOM:** Java-projekteissa releaseen tulee lisätä erikseen suoritettava jar-tiedosto
